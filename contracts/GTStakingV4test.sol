...
contract StakingTest is Ownable {
    ...
    uint256 public immutable seconds_per_day = 86400; // test , use 86400 for production
    uint256 public immutable warm_up_period = 27 days; // test , use days for production
    uint256 public immutable unlock_period = 60 days; // test , use days for production
    uint256 public immutable interaction_period_gap = 6 days; // test , use days for production
    uint256 public immutable reward_period = 7 days; // test , use days for production
    uint256 public immutable withdraw_delay = 30 days; // test , use days for production
